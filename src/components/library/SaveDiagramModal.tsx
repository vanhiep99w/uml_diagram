...
export default function SaveDiagramModal({ onSave, onCancel }: SaveDiagramModalProps) {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/50">
      ...
      >
        <h2 id="save-modal-title" className="text-lg font-semibold text-gray-900 mb-4">Save Diagram</h2>
        <div className="mb-4">
